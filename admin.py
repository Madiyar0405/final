...
counter = Counter('flask_requests_total', 'Total HTTP Requests')
successful_auth_counter = Counter('successful_auth_total', 'Total Successful Authentications')
product_added_counter = Counter('product_added_total', 'Total Products Added')
product_edited_counter = Counter('product_edited_total', 'Total Products Edited')
product_removed_counter = Counter('product_removed_total', 'Total Products Removed')
